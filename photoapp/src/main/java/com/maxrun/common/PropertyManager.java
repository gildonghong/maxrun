...
@Component
@PropertySource(value="classpath:appProps/sd.properties", ignoreResourceNotFound=true)
@PropertySource(value="classpath:appProps/sd-${spring.profiles.active}.properties", ignoreResourceNotFound=true)
